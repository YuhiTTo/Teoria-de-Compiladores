...
public class FinZenLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "FINANZAS", "INGRESO", "GASTO", "AHORRO", "MONTO", "PRESUPUESTO", 
			...
			"LBRACE", "RBRACE", "NUMERO", "DIGIT", "CADENA", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT"
		};
	}
	...
	public FinZenLexer(CharStream input) {
		super(input);
